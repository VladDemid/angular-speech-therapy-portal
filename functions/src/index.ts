...
// exports.queryTest = functions.https.onRequest((req: any, res: any) => {
//    cors(req, res, () => {
//       if (req.method !== 'GET') {
...
// exports.alfaAllReq = functions.https.onRequest((req: any, res: any) => {
//    cors(req, res, () => {
...
// exports.alfaReq = functions.https.onRequest((req: any, res: any) => {
...
// exports.alfaCall = functions.https.onCall((data: any, context: any) => {
...
// exports.randomNumberCall = functions.https.onCall((request: any, responce: any) => {
//    const number = Math.round(Math.random() * 100);
//    console.log(number)
//    // responce.send(number.toString());
//    return number
...
// exports.fireHttpEmail = functions.https.onCall((data: any, context: any) => {
